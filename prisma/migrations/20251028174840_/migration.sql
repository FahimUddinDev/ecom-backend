...
-- AddForeignKey
ALTER TABLE `products` ADD CONSTRAINT `products_childCategoryId_fkey` FOREIGN KEY (`childCategoryId`) REFERENCES `ChildCategories`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `OfferOnProduct` ADD CONSTRAINT `OfferOnProduct_productId_fkey` FOREIGN KEY (`productId`) REFERENCES `products`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `CouponOnProduct` ADD CONSTRAINT `CouponOnProduct_productId_fkey` FOREIGN KEY (`productId`) REFERENCES `products`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
